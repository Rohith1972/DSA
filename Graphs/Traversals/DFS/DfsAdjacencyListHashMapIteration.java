...
class Graph{
    ...
    public java.util.List<Integer> dfs(int s,boolean[] visited){
...
public class DfsAdjacencyListHashMapIteration {
    public static void main(String[] args) {
        ...
        java.util.List<Integer> res = g.dfs(start,new boolean[n]);
